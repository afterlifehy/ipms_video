package com.rt.g2.ui.activity.parking
...
import com.rt.g2.R
import com.rt.g2.databinding.ActivityParkingSpaceBinding
import com.rt.g2.dialog.PaymentQrDialog
import com.rt.g2.mvvm.viewmodel.ParkingSpaceViewModel
    ...
    override fun startObserve() {
        ...
        mViewModel.apply {
            parkingSpaceFeeLiveData.observe(this@ParkingSpaceActivity) {
                ...
                if (it.monthPay > 0L) {
                    val strings4 = arrayOf(i18N(com.rt.base.R.string.月结金额), "${AppUtil.keepNDecimal(it.monthPay / 100.00, 2)}元")
                    binding.tvMonthPay.text = AppUtil.getSpan(strings4, sizes, colors)
                } else {
                    binding.tvMonthPay.gone()
                }

                val strings5 = arrayOf(i18N(com.rt.base.R.string.待缴费用), "${AppUtil.keepNDecimal(it.amountPending / 100.00, 2)}元")
