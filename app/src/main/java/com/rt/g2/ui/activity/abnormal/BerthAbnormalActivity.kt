package com.rt.g2.ui.activity.abnormal
...
import com.rt.g2.R
import com.rt.g2.adapter.CollectionPlateColorAdapter
import com.rt.g2.databinding.ActivityBerthAbnormalBinding
import com.rt.g2.dialog.AbnormalClassificationDialog
import com.rt.g2.dialog.AbnormalStreetListDialog
import com.rt.g2.mvvm.viewmodel.BerthAbnormalViewModel
        ...
        when (v?.id) {
            ...
            R.id.rfl_report -> {
                ...
                if (binding.retParkingNo.text.toString().isEmpty()) {
                    ToastUtil.showBottomToast(i18n(com.rt.base.R.string.请填写泊位号))
                    return
                }
                if (type == "00") {
                    ToastUtil.showBottomToast(i18n(com.rt.base.R.string.请选择异常分类))
                    return
                }
                if ((type == "01" || type == "03") && binding.etPlate.text.toString().isEmpty()) {
                    ToastUtil.showBottomToast(i18n(com.rt.base.R.string.请填写车牌))
                    return
                }
                if (type == "01" || type == "03") {
                ...
                if ((type == "01" || type == "03") && checkedColor.isEmpty()) {
                    ToastUtil.showBottomToast(i18n(com.rt.base.R.string.请选择车牌颜色))
                    return
                }
                ...
                runBlocking {
                    ...
                    if (type == "04") {
                        val colors = intArrayOf(
                            com.rt.base.R.color.color_ff1a1a1a,
                        ...
                        if (type == "03") {
                            ...
                            mViewModel.abnormalReport(param)
                            ToastUtil.showBottomToast(i18n(com.rt.base.R.string.已上报请等待处理))
                            onBackPressedSupport()
                        }
                        EventBus.getDefault().post(ParkingSpaceBackEvent())
                    }
