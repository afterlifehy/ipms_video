...
import com.rt.ipms_geo.databinding.ItemParkingLotBinding
...
class ParkingLotAdapter(data: MutableList<ParkingLotBean>? = null, val onClickListener: OnClickListener) :
    ...
    init {
        ...
        plateBgMap[Constant.OTHERS_OLD] = com.rt.common.R.mipmap.ic_plate_bg_white
        ...
        plateTxtColorMap[Constant.OTHERS_OLD] = com.rt.base.R.color.black
    }
