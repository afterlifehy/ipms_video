...
import com.rt.ipms_geo.adapter.DebtCollectionAdapter
...
class CADebtCollectionActivity : VbBaseActivity<DebtCollectionViewModel, ActivityDebtCollectionBinding>(), OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.rrl_debtCollection -> {
                ...
                ARouter.getInstance().build(ARouterMap.CA_DEBT_ORDER_DETAIL).withParcelable(ARouterMap.DEBT_ORDER, debtCollectionBean)
    ...
    override fun startObserve() {
        super.startObserve()
        mViewModel.apply {
            debtInquiryLiveData.observe(this@CADebtCollectionActivity) {
