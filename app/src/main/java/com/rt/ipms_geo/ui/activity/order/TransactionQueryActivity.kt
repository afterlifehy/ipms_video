...
import com.rt.ipms_geo.adapter.TransactionQueryAdapter
import com.rt.ipms_geo.databinding.ActivityTransactionQueryBinding
import com.rt.ipms_geo.mvvm.viewmodel.TransactionQueryViewModel
import com.rt.ipms_geo.pop.DatePop
...
class TransactionQueryActivity : VbBaseActivity<TransactionQueryViewModel, ActivityTransactionQueryBinding>(), OnClickListener {
    ...
    override fun startObserve() {
        ...
        mViewModel.apply {
            ...
            debtInquiryLiveData.observe(this@TransactionQueryActivity) {
                dismissProgressDialog()
                if (it.result != null) {
