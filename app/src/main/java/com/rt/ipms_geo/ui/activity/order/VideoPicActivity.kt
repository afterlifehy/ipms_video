package com.rt.ipms_geo.ui.activity.order
...
import com.rt.ipms_geo.adapter.VideoPicPagerAdapter
import com.rt.ipms_geo.databinding.ActivityVideoPicBinding
import com.rt.ipms_geo.mvvm.viewmodel.VideoPicViewModel
import com.rt.ipms_geo.ui.fragment.VideoPicFragment
...
class VideoPicActivity : VbBaseActivity<VideoPicViewModel, ActivityVideoPicBinding>(), OnClickListener {
    ...
    override fun initView() {
        ...
        binding.layoutToolbar.tvTitle.text = i18N(com.rt.base.R.string.视频图片)
