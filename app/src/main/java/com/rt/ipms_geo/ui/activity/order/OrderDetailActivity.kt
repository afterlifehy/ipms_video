...
import com.rt.ipms_geo.databinding.ActivityOrderDetailBinding
import com.rt.ipms_geo.mvvm.viewmodel.OrderDetailViewModel
...
class OrderDetailActivity : VbBaseActivity<OrderDetailViewModel, ActivityOrderDetailBinding>(), OnClickListener {
    ...
    override fun initView() {
        ...
        val strings6 = arrayOf(i18N(com.rt.base.R.string.时长) + "：", AppUtil.millisToDate(order?.duration2!!.toLong() * 1000L))
