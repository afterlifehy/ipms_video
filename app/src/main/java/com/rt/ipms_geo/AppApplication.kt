...
import com.rt.ipms_geo.startup.OnAppBaseProxyManager
...
class AppApplication : BaseApplication() {
    ...
    override fun onCreate() {
        ...
        UMConfigure.init(this, "67ff0ea7bc47b67d833d0209", "android", UMConfigure.DEVICE_TYPE_PHONE, null)
        // 选用AUTO页面采集模式
