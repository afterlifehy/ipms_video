...
import ja.insepector.bxapp.databinding.ActivityCollectionManagementBinding
import ja.insepector.bxapp.dialog.AbnormalStreetListDialog
import ja.insepector.bxapp.dialog.SelectPicDialog
import ja.insepector.bxapp.mvvm.viewmodel.CollectionManagementViewModel
...
class CollectionManagementActivity : VbBaseActivity<CollectionManagementViewModel, ActivityCollectionManagementBinding>(), OnClickListener {
    ...
    override fun initView() {
        ...
        binding.layoutToolbar.tvTitle.text = i18N(ja.insepector.base.R.string.催缴管理)
