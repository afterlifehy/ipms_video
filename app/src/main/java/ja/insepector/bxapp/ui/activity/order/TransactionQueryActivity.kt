...
import ja.insepector.bxapp.adapter.TransactionQueryAdapter
import ja.insepector.bxapp.databinding.ActivityTransactionQueryBinding
import ja.insepector.bxapp.mvvm.viewmodel.TransactionQueryViewModel
    ...
    override fun startObserve() {
        ...
        mViewModel.apply {
            ...
            notificationInquiryLiveData.observe(this@TransactionQueryActivity) {
                dismissProgressDialog()
                ToastUtil.showToast(i18n(ja.insepector.base.R.string.开始打印))
