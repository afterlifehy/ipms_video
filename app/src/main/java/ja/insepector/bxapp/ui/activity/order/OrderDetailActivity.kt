...
class OrderDetailActivity : VbBaseActivity<OrderDetailViewModel, ActivityOrderDetailBinding>(), OnClickListener {
    ...
    val colors1 = intArrayOf(ja.insepector.base.R.color.color_ffe92404, ja.insepector.base.R.color.color_ffe92404, ja.insepector.base.R.color.color_ffe92404)
    ...
    override fun initView() {
        ...
        if (order?.paidAmount?.toDouble()!! > 0.0) {
            val strings = arrayOf(i18n(ja.insepector.base.R.string.已付), order?.paidAmount.toString(), i18n(ja.insepector.base.R.string.元))
            ...
            binding.rtvTransactionRecord.delegate.setBackgroundColor(
                ContextCompat.getColor(
                    BaseApplication.instance(), ja.insepector.base.R.color.color_ff0371f4
                )
            )
            ...
            binding.rtvTransactionRecord.delegate.setBackgroundColor(
                ContextCompat.getColor(
                    BaseApplication.instance(), ja.insepector.base.R.color.color_ffbac8d8
                )
            )
//            TODO("null")
            binding.rtvTransactionRecord.setOnClickListener(this)
        ...
        val strings6 = arrayOf(i18N(ja.insepector.base.R.string.时长) + "：", mintoString(order?.duration!!.toInt()))
