...
object HttpBuilder {
     ...
     */
    @JvmStatic
    fun getHttplogger(): ja.insepector.base.http.interceptor.HttpLoggingInterceptor {
        val logInterceptor = ja.insepector.base.http.interceptor.HttpLoggingInterceptor("okhttp3")
        logInterceptor.setPrintLevel(ja.insepector.base.http.interceptor.HttpLoggingInterceptor.Level.BODY)
    ...
    fun getOkhttpBuilder(
        ...
        val sslParams = ja.insepector.base.http.RetrofitUtils.getSSLParams()
