...
class ViewNetWorkStateManager(
    ...
    fun onCraete() {
        ja.insepector.base.network.NetWorkMonitorManager.getInstance().register(this)
    }
    ...
    fun onDestroy() {
        ja.insepector.base.network.NetWorkMonitorManager.getInstance().unregister(this)
        mHandler = null
    }
