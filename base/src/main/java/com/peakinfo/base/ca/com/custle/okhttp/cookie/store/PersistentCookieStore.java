...
package com.peakinfo.base.ca.com.custle.okhttp.cookie.store;
...
public class PersistentCookieStore implements CookieStore {
                ...
                if (encodedCookie != null) {
                    ...
                    if (decodedCookie != null) {
                        if (!this.cookies.containsKey(entry.getKey())) {
                            this.cookies.put(entry.getKey().toString(), new ConcurrentHashMap());
                        }
    ...
    public List<Cookie> get(HttpUrl uri) {
        ...
        if (this.cookies.containsKey(uri.host())) {
            Collection<Cookie> cookies = ((ConcurrentHashMap)this.cookies.get(uri.host())).values();
