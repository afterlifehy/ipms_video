...
public class MKConfig {
    ...
    public static final String cert_resolve = "/cert/resolve";
    public static final String cert_key_query = "/querycert/query";
    public static final String key_gen = "/key/gen";
    public static final String key_sign = "/key/sign";
    public static final String key_decrypt = "/sm2/dec";
    public static final String cert_apply = "/cert/apply";
    public static final String cert_re_apply = "/cert/resign";
